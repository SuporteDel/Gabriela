...
function pageServicos() {
    ...
    return `
      <div class="section">
        ...
        <!-- BLOCO PREVIDENCIÁRIO (destaque grande) -->
        <div class="promo" role="region" aria-label="Destaque Previdenciário">
          <div class="promo__kicker">${t("services.prevKicker")}</div>
          <h4 class="promo__title">${t("services.prevTitle")}</h4>
          <p class="promo__text">${t("services.prevText")}</p>
        ...
        <!-- BLOCO TRIBUTÁRIO (destaque grande) -->
        <div class="promo" role="region" aria-label="Destaque Tributário">
