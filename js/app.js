...
(function () {
  ...
  function pageInicio() {
    return `
      <div class="section section--intro">
        <div class="introCard introCard--premium">
          <div class="introCard__kicker">Ética • Estratégia • Atendimento humanizado</div>
          <h3 class="section__title">Início</h3>
          <div class="introCard__name">Gabriela Cordeiro</div>
          <div class="introCard__oab">Advogada • OAB MT 3439/O</div>
          <p class="introCard__areas">Tributário • Previdenciário • Cível • Atendimento online e presencial</p>
          <p class="section__lead introCard__lead">Atuação com foco em segurança jurídica, clareza técnica e soluções responsáveis, com atendimento humanizado e estratégico.</p>
          <div class="actions actions--center">
            <a class="btn btn--gold" href="${waLink(t("whats.home"))}" target="_blank" rel="noopener">Fale Conosco</a>
          </div>
        </div>
      </div>
    `;
    ...
    return `
      <div class="section">
        ...
        <div class="aboutGrid">
          ...
          <div class="aboutText">
            <p class="section__lead">Sou advogada com atuação especializada nas áreas de <strong>Direito Tributário</strong> e <strong>Direito Previdenciário</strong>, com formação acadêmica direcionada à análise técnica, estratégica e aprofundada das relações entre contribuinte e Estado.</p>

            <p class="muted">Possuo pós-graduação em <strong>Direito Tributário e Processo Tributário</strong>, com ênfase na interpretação da legislação fiscal, planejamento tributário, recuperação de créditos e contencioso judicial. Também sou pós-graduada em <strong>Processo Administrativo Tributário</strong>, área essencial para atuação perante órgãos fazendários, defesa em autos de infração e acompanhamento de fiscalizações.</p>

            <p class="muted">Além disso, detenho pós-graduação em <strong>Direito Previdenciário</strong>, o que me permite atuar de forma estratégica na proteção de direitos relacionados a benefícios previdenciários, revisões, planejamento e regularização de contribuições.</p>

            <div class="card mt">
              <h4 class="card__title">Minha atuação é pautada em:</h4>
              <ul class="list">
              ...
              <p class="muted mt">Acredito que o Direito deve ser utilizado como instrumento de organização, economia e proteção patrimonial, sempre com responsabilidade, ética e compromisso com resultados consistentes.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  function pageAtuacao() {
    return `
      <div class="section">
        ...
        <div class="grid grid--3 areasGrid">
          <div class="card">
  ...
  const SERVICES = {
    ...
    {id:"prev08", title:"Análise de Acordo com a Nova Reforma da Previdência", text:"A análise da Reforma da Previdência avalia o enquadramento do segurado nas regras de transição ou permanentes, permitindo identificar o melhor momento para requerer o benefício. A principal vantagem é a maximização do valor da aposentadoria, evitando escolhas prejudiciais e reduzindo riscos na tomada de decisão."},
    {id:"prev09", title:"Auxílio-acidente", text:"O auxílio-acidente é um benefício indenizatório concedido ao segurado que apresenta redução permanente da capacidade laboral após acidente ou doença. Pode ser acumulado com salário. A principal vantagem é a indenização mensal vitalícia, sem impedir o retorno ao trabalho."},
    {id:"prev10", title:"Benefício assistencial BPC/LOAS", text:"O BPC/LOAS garante um salário mínimo mensal à pessoa com deficiência ou ao idoso em situação de vulnerabilidade social. Não exige contribuição ao INSS. A principal vantagem é a proteção social para quem não possui meios de subsistência."},
    ...
    civel: [
    {id:"civ01", title:"Divórcio", text:"O divórcio é o procedimento legal que formaliza o fim do casamento. Ele pode ocorrer de forma consensual, quando ambas as partes concordam com a separação e com questões como divisão de bens, guarda dos filhos e pensão, ou de forma litigiosa, quando não há acordo e o caso precisa ser analisado pelo Poder Judiciário. A orientação jurídica adequada permite conduzir o processo com segurança, observando os direitos de cada parte e o cumprimento da legislação."},
    {id:"civ02", title:"Pensão alimentícia", text:"A pensão alimentícia é destinada a garantir recursos necessários para a manutenção e o desenvolvimento de quem dela necessita, especialmente filhos menores. O processo pode envolver o pedido inicial de pensão, a revisão do valor quando houver mudança na situação financeira das partes ou nas necessidades do beneficiário, bem como a cobrança de valores que não tenham sido pagos. O objetivo é assegurar que a obrigação seja estabelecida e cumprida de forma justa e proporcional."},
    {id:"civ03", title:"Guarda dos filhos", text:"A definição da guarda dos filhos ocorre quando os pais não vivem mais juntos e é necessário estabelecer como serão tomadas as decisões relacionadas à vida da criança. A guarda pode ser compartilhada, quando ambos os pais participam das decisões importantes, ou unilateral, quando a responsabilidade principal fica com apenas um dos genitores. Também pode ser realizada a regulamentação de convivência, para organizar o direito de visitas e garantir o vínculo familiar, sempre considerando o melhor interesse da criança."},
    {id:"civ04", title:"Reconhecimento ou investigação de paternidade", text:"O reconhecimento ou a investigação de paternidade é o procedimento utilizado para estabelecer juridicamente o vínculo entre pais e filhos quando esse reconhecimento não ocorreu de forma voluntária. O processo pode incluir a realização de exame de DNA e outras provas para confirmação da filiação. Após o reconhecimento, é possível regularizar o registro civil e assegurar direitos importantes, como pensão alimentícia, nome e vínculo familiar."},
    {id:"civ05", title:"Adoção", text:"A adoção é um processo legal que cria um vínculo definitivo de filiação entre adotantes e adotado, garantindo à criança ou ao adolescente os mesmos direitos de um filho biológico. O procedimento exige o cumprimento de requisitos previstos em lei e acompanhamento do Poder Judiciário, sempre com foco na proteção e no melhor interesse da criança."},
    {id:"civ06", title:"Partilha de bens", text:"A partilha de bens é o procedimento utilizado para dividir o patrimônio adquirido durante o relacionamento, de acordo com o regime de bens adotado pelo casal. Essa divisão pode ocorrer no momento do divórcio ou após a separação e envolve a análise de bens, direitos e eventuais dívidas do casal, buscando uma solução adequada e conforme a legislação."},
    {id:"civ07", title:"União estável", text:"A união estável ocorre quando duas pessoas convivem publicamente como se casadas fossem, com intenção de constituir família. Em determinadas situações, pode ser necessário realizar o reconhecimento formal dessa união para garantir direitos patrimoniais, previdenciários e sucessórios. Também é possível realizar a dissolução da união estável quando o relacionamento chega ao fim, definindo questões como partilha de bens, guarda dos filhos e pensão alimentícia."},
    {id:"civ08", title:"Violência doméstica", text:"Em casos de violência doméstica ou familiar, a legislação brasileira prevê mecanismos de proteção à vítima por meio da Lei Maria da Penha. Entre as medidas possíveis estão pedidos de medidas protetivas, como afastamento do agressor, proibição de contato e outras providências destinadas a preservar a integridade física e emocional da vítima."},
    {id:"civ09", title:"Interdição e curatela", text:"A interdição é um procedimento judicial utilizado quando uma pessoa não possui condições de administrar seus próprios atos da vida civil em razão de doença, deficiência ou incapacidade. Nesses casos, pode ser nomeado um curador, responsável por auxiliar ou representar essa pessoa na gestão de seus interesses, sempre sob acompanhamento e autorização do Poder Judiciário."}
    ]
  };
...
function pageServicos() {
    ...
    return `
      <div class="section">
        ...
        <div class="svcSection">
          <div class="promo promo--mini" role="region" aria-label="Destaque Cível">
            <div class="promo__kicker">DIREITO CÍVEL</div>
            <h4 class="promo__title">Proteja seus direitos e os da sua família com orientação jurídica especializada.</h4>
            <p class="promo__text">Atuação cuidadosa, humana e estratégica para conduzir cada caso com clareza, segurança e responsabilidade jurídica.</p>
            <a class="btn btn--gold promo__btn" target="_blank" rel="noopener" href="${waLink(t("whats.services"))}">
              Fale Conosco
            </a>
          </div>
          <h4 class="h4">Direito Cível</h4>
          ${mkCards(SERVICES.civel, 'civ')}
        </div>
      </div>
    `;
  }
  ...
  function pageAvaliacoes() {
    const reviews = [
      {name:"Vanessa Santtos", meta:"um ano atrás", text:"Recomendo o trabalho desse escritório, profissionais competentes e ágeis."},
      {name:"Francisca Lima", meta:"2 meses atrás", text:"Ótimo atendimento, muito atencioso."},
      {name:"Andreia Chagas", meta:"4 meses atrás", text:"Super bem atendida, super indico."},
      {name:"Angra Gesimara Silva Guimaraes", meta:"6 meses atrás", text:"Atendimento cordial e prestativo. Atendimento inicial excelente, aguardando próximo passo."},
    ];
    return `
      <div class="section">
        <h3 class="section__title">Avaliações</h3>
        <p class="section__lead">Visualize os comentários de nossos clientes.</p>
        <div class="grid grid--2 reviewsGrid">
          ${reviews.map(r => `
            <article class="reviewCard">
              <div class="reviewCard__top">
                <div>
                  <h4 class="reviewCard__name">${r.name}</h4>
                  <div class="reviewCard__meta">Google Reviews • ${r.meta}</div>
                </div>
                <div class="reviewCard__stars" aria-label="5 estrelas">★★★★★</div>
              </div>
...
/* =======================
  ...
  function renderSinglePage(){
    ...
    pageEl.innerHTML = `
      <section id="inicio" data-section>${pageInicio()}</section>
      <section id="quem-sou" data-section>${pageQuemSou()}</section>
      <section id="atuacao" data-section>${pageAtuacao()}</section>
      <section id="servicos" data-section>${pageServicos()}</section>
      <section id="avaliacoes" data-section>${pageAvaliacoes()}</section>
      <section id="agendamento" data-section>${pageAgendamento()}</section>
      <section id="atendimento" data-section>${pageAtendimento()}</section>
      <section id="conteudos" data-section>${pageConteudos()}</section>
      <section id="contato" data-section>${pageContato()}</section>
    `;
    ...
    // WhatsApp do Hero e CTAs de agendamento
    ...
    document.querySelectorAll('.js-agendar').forEach((el)=>{
      el.setAttribute('href', waLink('Olá! Gostaria de agendar um atendimento.'));
      el.setAttribute('target', '_blank');
      el.setAttribute('rel', 'noopener');
    });

    if (window.initCalendar) window.initCalendar(currentLang);
  }
