...
(function () {
  ...
  const REVIEWS = [
    {
      name: "Vanessa Santtos",
      meta: "1 ano atrás",
      text: "Recomendo o trabalho desse escritório, profissionais competentes e ágeis.",
      initial: "V"
    },
    {
      name: "Francisca Lima",
      meta: "2 meses atrás • 2 avaliações",
      text: "Ótimo atendimento, muito atencioso e profissional.",
      initial: "F"
    },
    {
      name: "Andreia Chagas",
      meta: "4 meses atrás • 1 avaliação",
      text: "Super bem atendida, super indico.",
      initial: "A"
    },
    {
      name: "Angra Gesimara Silva Guimaraes",
      meta: "6 meses atrás • Local Guide",
      text: "Atendimento cordial e prestativo. Atendimento inicial excelente, aguardando o próximo passo.",
      initial: "A"
    }
  ];
    ...
    return `
      <div class="section section--reviews">
        <div class="reviewsHero">
          <span class="reviewsHero__kicker">DEPOIMENTOS</span>
          <h3 class="section__title section__title--light">Visualize os comentários de nossos clientes</h3>
          <p class="section__lead section__lead--light">Depoimentos reais que reforçam a seriedade, a atenção e o compromisso em cada atendimento.</p>
        </div>

        <div class="reviewsGrid">
          ${REVIEWS.map((r) => `
            <article class="reviewCard reveal">
              <div class="reviewCard__top">
                <div class="reviewCard__person">
                  <span class="reviewCard__avatar">${r.initial}</span>
                  <div>
...
/* =======================
  ...
  function renderSinglePage(){
    ...
    pageEl.innerHTML = `
      ...
      <section id="avaliacoes" data-section>${pageReviews()}</section>
