...
(function () {
  ...
  function pageInicio() {
    return `
      <div class="section section--editorial section--intro">
        <div class="introPanel reveal is-visible">
          <span class="kicker">Ética • Estratégia • Atendimento humanizado</span>
          <h3 class="section__title">Início</h3>
          <p class="introLead"><strong>Gabriela Cordeiro — OAB/MT 3439/O</strong></p>
          <p class="meta">Tributário • Previdenciário • Cível • Atendimento online e presencial</p>
          <p class="section__lead">Atuação com foco em segurança jurídica, clareza técnica e soluções responsáveis, com atendimento humanizado e estratégico.</p>
  ...
  function pageAtuacao() {
    return `
      <div class="section section--editorial">
        ...
        <div class="grid grid--3 areaGrid">
          ...
          <div class="card areaCard">
            ...
            <ul class="list">
              ...
              <li>Guarda dos filhos e convivência</li>
              <li>Investigação de paternidade</li>
              <li>União estável</li>
              <li>Medidas protetivas e curatela</li>
            </ul>
          </div>
        </div>

        <div class="card mt areaStrategy">
...
/* =======================
  ...
  function renderSinglePage(){
    ...
    pageEl.innerHTML = `
      <section id="inicio" data-section class="sectionWrap sectionWrap--light">${pageInicio()}</section>
      <section id="quem-sou" data-section class="sectionWrap sectionWrap--dark">${pageQuemSou()}</section>
      <section id="atuacao" data-section class="sectionWrap sectionWrap--light">${pageAtuacao()}</section>
      <section id="servicos" data-section class="sectionWrap sectionWrap--dark">${pageServicos()}</section>
      <section id="agendamento" data-section class="sectionWrap sectionWrap--light">${pageAgendamento()}</section>
      <section id="atendimento" data-section class="sectionWrap sectionWrap--dark">${pageAtendimento()}</section>
      <section id="conteudos" data-section class="sectionWrap sectionWrap--light">${pageConteudos()}</section>
      <section id="contato" data-section class="sectionWrap sectionWrap--dark">${pageContato()}</section>
    `;
