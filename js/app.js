    ...
    return `
      <div class="section section--intro">
        <div class="hero hero--center">
          ...
          <h4 class="h4 home__name">Gabriela Cordeiro</h4>
          <p class="meta home__meta">Advogada • OAB/MT 3439/O</p>
          <p class="meta">${t("home.meta1")} • ${t("home.meta2")} • Cível • ${t("home.meta3")}</p>
...
/* =======================
  ...
  function renderSinglePage(){
    ...
    pageEl.innerHTML = `
      <section id="inicio" class="section--light" data-section>${pageInicio()}</section>
      <section id="quem-sou" class="section--dark" data-section>${pageQuemSou()}</section>
      <section id="atuacao" class="section--light" data-section>${pageAtuacao()}</section>
      <section id="servicos" class="section--dark" data-section>${pageServicos()}</section>
      <section id="agendamento" class="section--light" data-section>${pageAgendamento()}</section>
      <section id="atendimento" class="section--dark" data-section>${pageAtendimento()}</section>
      <section id="conteudos" class="section--light" data-section>${pageConteudos()}</section>
      <section id="contato" class="section--dark" data-section>${pageContato()}</section>
    `;
